...
export interface DemoStatus { enabled: boolean; candidate_count: number; lifetime_hours: number; active_sessions: number; max_sessions: number; at_capacity: boolean }
