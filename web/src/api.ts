...
export interface DemoWaitlistEntry { position: number; masked_email: string }
export interface DemoStatus { enabled: boolean; candidate_count: number; lifetime_hours: number; active_sessions: number; max_sessions: number; at_capacity: boolean; waitlist_count: number; waitlist: DemoWaitlistEntry[] }
