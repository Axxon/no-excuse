...
Run `composer licenses` inside the API container and inspect `web/package-lock.json` before publishing a binary distribution after dependency upgrades. This notice must be reviewed whenever either lock file changes.
